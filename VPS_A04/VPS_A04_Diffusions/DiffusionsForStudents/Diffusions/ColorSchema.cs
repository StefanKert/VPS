...
namespace Diffusions
{
    public static class ColorSchema
    {
        ...
        public static IList<Color> Colors
        {
            get
            {
                if (readOnlyColors == null)
                    readOnlyColors = colors.AsReadOnly();
        ...
        static ColorSchema() {
            ...
            for (int i = 0; i < shades; i++) {
                ...
                switch (currentClass) {
                    case 0: {
                        colors.Add(Color.FromArgb(0, currentValue, 255));
                        break;
                    } // blue -> cyan
                    case 1: {
                        colors.Add(Color.FromArgb(0, 255, 255 - currentValue));
                        break;
                    } // cyan -> green
                    case 2: {
                        colors.Add(Color.FromArgb(currentValue, 255, 0));
                        break;
                    } // green -> yellow
                    case 3: {
                        colors.Add(Color.FromArgb(255, 255 - currentValue, 0));
                        break;
                    } // yellow -> red
                }
            }
